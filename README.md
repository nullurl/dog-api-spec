...
> 受《HUMAN API — 人类接口规范》启发，用同一套工程文体处理另一种已经大规模部署、却始终没有官方说明书的系统：**狗**。
...
- **DOG API** —— 36 章 + 附录 A–R。嗅觉阵列全双工、摇尾的方向性编码、地磁对齐、全天行为预算、生理基线、就医标准场景、量化接口定义、表情接口定义、外设总线、与人类的互操作。
